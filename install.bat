@echo off
title MJ Reverse AI - Multi-Model Setup
color 0E

echo ===================================================
echo     MJ REVERSE AI - MULTI-MODEL SETUP             
echo ===================================================
echo.
echo This will download and configure AI models onto
echo your computer. You'll get to CHOOSE which models
echo to install from a curated list.
echo.
echo  - 6 preset models (uncensored + standard)
echo  - Custom model support (bring your own GGUF)
echo  - Minimum disk space: 16 GB (32 GB recommended)
echo.
...
echo ===================================================
echo.
echo To start your AI, double-click START.bat
echo.
pause
