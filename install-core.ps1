...
$ModelCatalog = @(
   ...
   @{
        Num      = 2
        Name     = "CodeGemma 7B"
        File     = "codegemma-7b-q4_k_m.gguf"
        URL      = "https://huggingface.co/Aashraf995/codegemma-7b-Q4_K_M-GGUF/resolve/main/codegemma-7b-q4_k_m.gguf"
        Size     = "4.8"
        MinBytes = 4500000000
        Local    = "codegemma-local"
        Label    = "STANDARD"
        Badge    = "CODING"
        Prompt   = "You are a helpful and precise AI coding assistant. Provide clean, well-optimized code answers."
    },
    @{
        Num      = 3
        ...
        Label    = "STANDARD"
        Badge    = "CODING"
        Prompt   = "You are Qwen2.5-Coder, an expert AI programming assistant developed by Alibaba Cloud. Answer helpfully and accurately."
    },
    @{
        Num      = 4
...
Write-Host "   MJ REVERSE AI - Multi-Model Setup                      " -ForegroundColor Cyan
Write-Host "==========================================================" -ForegroundColor Cyan
Write-Host ""
...
if ($freeGB -gt 0) {
    Write-Host "  Disk Free Space: $freeGB GB" -ForegroundColor DarkGray
    Write-Host ""
}
...
# -----------------------------------------------------------------
# Disk space warning (if selecting 3+ models or all)
# -----------------------------------------------------------------
$totalSizeGB = 0
...
if ($SelectedModels.Count -ge 3 -or $UserChoice.Trim().ToLower() -eq "all") {
    ...
    Write-Host "  Local drive needs at least ~$neededGB GB free!" -ForegroundColor Red
...
# =================================================================
Write-Host ""
Write-Host "[3/4] Downloading AI Model(s)..." -ForegroundColor Yellow
...
# =================================================================
Write-Host ""
Write-Host "[4/4] Creating AI model configurations..." -ForegroundColor Yellow
